...
% LABELS
% =========================================================
xlabel(ax, 'Energy per lap [kWh]', 'Color','k','FontSize',25,'FontName','Times');
ylabel(ax, 'Lap time [s]',        'Color','k','FontSize',25,'FontName','Times');
...
% EXPORT
% =========================================================
exportgraphics(gcf, fullfile(output_folder, 'lap_vs_energy.pdf'), ...

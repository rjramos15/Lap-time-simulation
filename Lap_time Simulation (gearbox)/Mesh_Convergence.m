...
xlabel(ax1, 'ds [m]', 'FontName','Times','FontSize',25,'Color','k');
ylabel(ax1, 'Lap time [s]', 'FontName','Times','FontSize',25,'Color','k');

leg1 = legend(ax1, {'Simulation data','Trend','Converged value'}, ...
    'Location','northeast','Box','off','TextColor','k','FontSize',20);
set(leg1,'Color','none');
...
xlabel(ax2, 'ds [m]', 'FontName','Times','FontSize',25,'Color','k');
ylabel(ax2, 'Relative error [-]', 'FontName','Times','FontSize',25,'Color','k');

leg2 = legend(ax2, {'Relative error','Trend'}, ...
    'Location','southwest','Box','off','TextColor','k','FontSize',20);
set(leg2,'Color','none');
